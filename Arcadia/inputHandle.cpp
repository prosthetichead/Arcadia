...
void inputHandle::init(dbHandle &db_obj)
{
	...
	inputStates.push_back(item);
	item = db_obj.getInputItem(inputs::filter_1_left);
	inputStates.push_back(item);
	item = db_obj.getInputItem(inputs::filter_1_right);
	inputStates.push_back(item);
	item = db_obj.getInputItem(inputs::filter_2_left);
	inputStates.push_back(item);
	item = db_obj.getInputItem(inputs::filter_2_right);
	inputStates.push_back(item);
	item = db_obj.getInputItem(inputs::show_favs);
	inputStates.push_back(item);
